...
async function verify() {
  ...
  console.log('\n=== 2. VERIFYING 7 ACADEMIC TABLES SPECIFICALLY ===');
  ...
  console.log('\n=== 4. VERIFYING PARTIAL UNIQUE INDEXES (Academic Layer) ===');
  ...
  console.log('\n=== 6. VERIFYING ABSENCE OF FORBIDDEN TABLES (Students, Teachers, Promotion) ===');
